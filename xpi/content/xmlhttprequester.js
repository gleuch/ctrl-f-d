function ctrlfd_xmlhttpRequester(unsafeContentWin, chromeWindow) {
...
ctrlfd_xmlhttpRequester.prototype.contentStartRequest = function(details) {
	...
	switch (scheme) {
		...
		case "ftp":
			this.chromeWindow.setTimeout(
				ctrlfd_gmCompiler.hitch(this, "chromeStartRequest", url, details), 0);
			break;
		default:
...
ctrlfd_xmlhttpRequester.prototype.chromeStartRequest=function(safeUrl, details) {
...
ctrlfd_xmlhttpRequester.prototype.setupRequestEvent =
